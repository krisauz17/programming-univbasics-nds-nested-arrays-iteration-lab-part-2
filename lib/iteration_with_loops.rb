def find_min_in_nested_arrays(array_of_daily_temperatures)
  ...
  row_index = 0
    ...
    low_temperature = 30
      ...
      if array_of_daily_temperatures[row_index][element_index] < low_temperature
      low_temperature = array_of_daily_temperatures[row_index][element_index]
      end
    element_index += 1

    end
    daily_temperatures_results << low_temperature
    row_index += 1
  end

  daily_temperatures_results
  #p daily_temperatures_results
